...
const Pricing = ({ pricingPromise }) => {
  ...
  return (
    <div className="max-w-285 mx-auto my-20 md:my-24 lg:my-30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-5 lg:gap-6 px-4 mt-6 md:mt-10">
